...
DEBUG=""
tmux split-window -h -t 1 "sudo ./execNS ns3 $DEBUG_PREF ../../../build/tools/eth_test veth3-0 $veth0_3; read"
sudo ./execNS ns0 $DEBUG_PREF ../../../build/tools/eth_test veth0-3 $veth3_0
wait
cd ../examples/
