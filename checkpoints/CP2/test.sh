...
sudo ./execNS ns0 ../../../build/tools/eth_test veth0-3 $veth3_0 2>/dev/null &
sudo ./execNS ns3 ../../../build/tools/eth_test veth3-0 $veth0_3 veth3-2 $veth2_3 veth3-4 $veth4_3 2>/dev/null &
sudo ./execNS ns4 ../../../build/tools/eth_test veth4-3 $veth3_4 2>/dev/null &
sudo ./execNS ns2 ../../../build/tools/eth_test veth2-1 $veth1_2 veth2-3 $veth3_2 2>/dev/null &
sudo ./execNS ns1 ../../../build/tools/eth_test veth1-2 $veth2_1 2>/dev/null &
wait
cd ../examples/
